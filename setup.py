...
setup(
    ...
    project_urls={
        "documentation": "https://pybam.readthedocs.io",
        "homepage": "https://github.com/sjin09/pybam",
        "repository": "https://github.com/sjin09/pybam"
    },
    author='Sangjin Lee',
    ...
    entry_points={"console_scripts": ["pybam = pybam.__main__:main"]},
    packages=['pybam'],
    package_dir={"": "src"},
    package_data={"pybam": ["*.typed"]},
    install_requires=[
        'argparse==1.*,>=1.4.0', 'click==7.*,>=7.0.0', 'pysam==0.*,>=0.16.0'
    ],
    extras_require={
        "dev": [
